...
public static class ArtistasExtensions
{
    public static void AddEndPointsArtistas(this WebApplication app)
    {
        ...
        app.MapGet("/Artistasid/{id}", ([FromServices] DAL<Artista> dal,int id ) =>
        {
        ...
        {
            var nome = artistaRequest.nome.Trim(); // para tirar os espaços
            var imagemArtista = DateTime.Now.ToString("ddMMyyyyhhss") + "." + nome + ".jpeg"; //nomeando o arquivo

            var path = Path.Combine(env.ContentRootPath,
                      "wwwroot", "FotoPerfil", imagemArtista); //caminho do meu arquivo 
